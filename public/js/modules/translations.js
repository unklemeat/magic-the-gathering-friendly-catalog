...
export const translations = {
  ita: {
    ...
    modalJsonSaved: 'Dati salvati con successo!',
    ...
    createCollectionBtn: 'Crea',
    deleteCollectionBtn: 'Elimina',
    newCollectionPrompt: 'Inserisci il nome della nuova collezione:',
    deleteCollectionConfirm: 'Sei sicuro di voler eliminare questa collezione? Tutte le carte al suo interno verranno perse.',
    selectCollectionTitle: 'Seleziona Collezione',
    modalNoCollections: 'Nessuna collezione trovata. Creane una prima di aggiungere carte.',
    modalImportConflictTitle: 'Conflitto di Nomi',
    modalImportConflictText: 'Esiste già una collezione chiamata ":NAME:". Cosa vorresti fare?',
    mergeBtn: 'Unisci',
  ...
  eng: {
    ...
    modalJsonSaved: 'Data successfully saved!',
    ...
    collectionResetBtn: 'Reset',
    createCollectionBtn: 'Create',
    deleteCollectionBtn: 'Delete',
    newCollectionPrompt: 'Enter the name for the new collection:',
    deleteCollectionConfirm: 'Are you sure you want to delete this collection? All cards within it will be lost.',
    selectCollectionTitle: 'Select Collection',
    modalNoCollections: 'No collections found. Please create one before adding cards.',
    modalImportConflictTitle: 'Name Conflict',
    modalImportConflictText: 'A collection named ":NAME:" already exists. What would you like to do?',
    mergeBtn: 'Merge',
